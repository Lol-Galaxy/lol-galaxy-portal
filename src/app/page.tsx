...
const APPS = [
  ...
  },
  {
    ...
    description:
      "Simule une draft compétitive à 10 joueurs en temps réel : picks et bans tour par tour selon les règles officielles de tournoi.",
    href: "https://loldurafutu.up.railway.app",
    available: true,
    accentClass: "glow-red",
    borderColor: "oklch(0.60 0.22 20 / 0.4)",
    badge: "Disponible",
